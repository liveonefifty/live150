...
export default function Service() {
  return (
    <div className='prose mx-auto mb-10 mt-48 max-w-3xl'>
      ...
      <p>
        These terms and conditions apply to the Live150 app (hereby referred to
        as "Application") for mobile devices that was created by
        HEALTHHUSTLER.AI CORPORATION (hereby referred to as "Service Provider")
      ...
      <p>These terms and conditions are effective as of 2024-10-23.</p>
      ...
      <p>
        ...
        <a href='mailto:contact@healthhustler.ai'>contact@healthhustler.ai</a>.
      </p>
    </div>
  );
}
