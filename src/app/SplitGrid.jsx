...
export default function SplitGrid() {
  return (
    <div className='grid w-full grid-cols-1 gap-4 md:grid-cols-2'>
      <motion.div
        className='flex aspect-video w-full flex-col justify-center rounded-[40px] bg-[#F6F6F6] px-4 md:px-12'
        initial={{ opacity: 0, x: -20 }}
        whileInView={{ opacity: 1, x: 0 }}
        viewport={{ margin: '-100px', once: true }}
        transition={{ duration: 0.5, delay: 0.1 }}
      >
        <h4 className='text-2xl font-medium md:text-5xl'>
          Frictionless WhatsApp Interface
        </h4>
        <p className='mt-4 max-w-md text-sm text-[#252525] md:text-2xl'>
